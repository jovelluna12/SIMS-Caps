...
class InvortoryGUI:
    ...
    def Click_Stack(self):
        ...
        btn_filter_clear=Button(self.Frame_stack,text="Clear Filters",command= self.Stack_clearFilter)
    ...
    def Click_Delivery(self):
        ...
        self.frame_Table['columns'] = ("ID", "Name", "Detail",  "Arrival")
        self.frame_Table.column("#0", width=0, stretch=NO)
        self.frame_Table.column("ID", anchor=W, width=100, stretch=NO)
